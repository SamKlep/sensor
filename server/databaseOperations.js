...
//     db.all(`SELECT * FROM dhtreadings ORDER BY createdAt DESC LIMIT ${limit}`, callback)
// }

// const fetchReadingsBetweenTime = (type, start, end, callback) => {
//     db.all(`SELECT * FROM dhtreadings WHERE createdAt > ? AND createdAt < ?;`, [start, end], callback)
// }

// const getAverageOfReadingsBetweenTime = (type, start, end, callback) => {
//     db.get(`SELECT avg(value) FROM dhtreadings WHERE createdAt > ? AND createdAt < ?;`, [start, end], callback)
// }
